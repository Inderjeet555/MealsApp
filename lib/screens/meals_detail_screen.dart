...
class MealsDetailScreen extends StatelessWidget {
  ...
  MealsDetailScreen(this.toggleFavourites, this.isMealFavourite);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        floatingActionButton: FloatingActionButton(
          onPressed: () => toggleFavourites(mealsId),
          child: Icon(
            isMealFavourite(mealsId) ?  Icons.favorite : Icons.star_border,
          ),
        ));
  }
}
